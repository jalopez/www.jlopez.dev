...
const Footer: FC = () => {
  return (
    <footer className="bg-gray-100 px-3 py-6 text-center">
      <div className="mt-4 justify-center flex flex-wrap">
        {/* Github */}
        <LinkIcon href="https://github.com/jalopez">
